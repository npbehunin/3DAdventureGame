...
//Handles equipping different weapons
//Shows which Main weapon is currently equipped.
//Eventually, store a bow and bomb into sub equip slots that the player can quick switch to in game.

public class EquipWeapon3D : MonoBehaviour
{
	...
	//*Get the list of swords, bows, and bombs from WeaponManager.
